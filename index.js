...
// alter table
// alter = `delete from products where productcode='asb10'`;
// db.run(alter, (err) => {
//     if (err) throw err;
...
// addProduct('asb10','boAt Airdopes 113 Wireless Gaming Earbuds','Experience the best music listening with the boAt Airdopes 113 Wireless Gaming Earbuds with Environmental Noise Cancellation. Discover the power of its 13mm drivers, which enable the music to ring out clearly and loudly during every jam session. Be astounded by the music of the future rather than merely listening to these earphones. Conversations are as clear as they would be in person thanks to ENx technology. You will always be heard thanks to Airdopes 113. With the aid of the Insta Wake N Pair technology, connecting and unplugging your Airdopes takes only a few seconds',
...
// addProduct('las20','ASUS TUF Gaming A15 FA506QM-HN124W AMD Ryzen 9','15.6 inch, 16GB, 512GB, Windows 11 Home, NVIDIA GeForce RTX 3060, FHD IPS Display, Graphite Black, 90NR0607-M003K0',
// '512GB SSD', 'Windows 11 Home','15.6-Inch Full HD Display','AMD Ryzen 9 Octa Core 10th Gen Processor',
// "images/asus/las20.avif","images/asus/las21.avif","images/asus/las22.avif","images/asus/las23.avif",4, 210, false, 'TUF Gaming', 'Laptops',119990, 98000, 200, 132);

// addProduct('las30','Asus ROG Strix G15 AMD Ryzen 7 ','15.6 inch, 16GB, 1TB, Windows 11 Home, MS Office 2021, NVIDIA GeForce RTX 3050 Ti, Full HD IPS Display, Eclipse Gray, 90NR0582-M001K0',
// '15.6-in FHD Display', 'AMD Ryzen 7 4800H Mobile Processor','16GB DDR4','1TB PCIe 3.0 NVMe M.2 SSD',
// "images/asus/las30.avif","images/asus/las31.avif","images/asus/las32.avif","images/asus/las33.avif",4.5, 210, false, 'ROG Strix', 'Laptops',115990, 85990, 350, 195);
...
// addUser("Thanush","thanush@gmail.com","Thanush@123",false);
...
app.get('/:id', (req, res) => {
  ...
  db.all("select * from products",(err, products) => {
    ...
    if (product.productcode === pid){
      res.render('singlepage', { data: product , title: "Single product" });
    }});
  })
});
